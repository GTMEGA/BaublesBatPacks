...
public class recipes {
    ...
    public static void load() {
        ...
        ItemStack crystal = GT_ModHandler.getModItem("IC2", "itemBatCrystal", 1, GT_Values.W);
        {
            ...
            GT_ModHandler.addCraftingRecipe(BatPack.stack,
                                            new Object[]{"BCB", "BIB", "BWB",
                                                         'B', reBat,
                                                         'C', circuit,
                                                         'I', ironCase,
                                                         'W', wire});
        ...
        }
        {
            ...
            GT_ModHandler.addCraftingRecipe(AdvPack.stack,
                                            new Object[]{"BCB", "BIB", "BWB",
                                                         'B', reBat,
                                                         'C', circuit,
                                                         'I', ironCase,
        ...
        }
        {
            ...
            GT_ModHandler.addCraftingRecipe(EnergyPack.stack,
                                            new Object[]{"CIC", "BRB", "IWI",
                                                         'B', crystal,
                                                         'C', circuit,
                                                         'I', ironCase,
                                                         'W', wire,
        ...
        }
        {
            ...
            GT_ModHandler.addCraftingRecipe(UltimateLapPack.stack,
                                            new Object[]{"IBI", "BRB", "CWC",
                                                         'B', lap,
                                                         'C', circuit,
                                                         'I', ironCase,
                                                         'W', wire,
                                                         'R', AdvancedLapPack.stack});
        }
        {
            ...
            GT_ModHandler.addCraftingRecipe(EpicLapPack.stack,
                                            new Object[]{"IBI", "BRB", "CWC",
                                                         'B', lap,
                                                         'C', circuit,
                                                         'I', ironCase,
                                                         'W', wire,
                                                         'R', UltimateLapPack.stack});
        }
        {
            ItemStack carbon = GT_ModHandler.getModItem("IC2", "itemPartCarbonPlate", 1);
            ...
            Items.feather.setDamage(EnergyPack.stack, GT_Values.W);
            GT_ModHandler.addCraftingRecipe(AdvancedLapPack.stack,
                                            new Object[]{"CEC", "EBE", "WTW",
                                                         'C', carbon,
                                                         'E', crystal,
                                                         'B', EnergyPack.stack,
                                                         'W', wire,
